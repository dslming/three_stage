...
export class Rotation {
  constructor(param) {
    ...
    this.rotateUpStart = new THREE.Vector2();
    this.rotateUpEnd = new THREE.Vector2();

    this.rotateLeftStart = new THREE.Vector2();
    this.rotateLeftEnd = new THREE.Vector2();
  ...
  setRotateUpEnd(x, y) {
    ...
    const rotateDelta = new THREE.Vector3()
